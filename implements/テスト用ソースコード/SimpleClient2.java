/*
 * サーバのテストのために, Recever, login, isLogined()を追加.
 * receiveMessageを改変
 */
...
public class SimpleClient2 extends JFrame implements MouseListener {
	...
	private Receiver receiver;		//追加
	private boolean login;		//追加
	public boolean isLogined(){	//追加
		return login;
	}
	// コンストラクタ
				...
				try{
					while(true) {//データを受信し続ける
						...
						if (inputLine != null){//データを受信したら
							if (inputLine.equals("login success"))
								login = true;
	...
	public static void main(String args[]){
		SimpleClient2 oclient = new SimpleClient2();
